...
void RedeNeural::TreinarRede(const std::string entradas,const std::string saidas_esperadas, int porcentagem_testes, bool logs){
    int num_treinos=100, num_testes=100, num_dados;
    ...
    std::cout<<std::endl<<std::endl<<"|INICIANDO TREINAMENTO|"<<std::endl;
    ...
    std::cout<<std::endl<<std::endl<<"|INICIANDO TESTES|"<<std::endl;
